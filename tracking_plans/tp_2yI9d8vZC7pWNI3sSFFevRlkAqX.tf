import {
  to = segment_tracking_plan.id-tp_2yI9d8vZC7pWNI3sSFFevRlkAqX
  id = "tp_2yI9d8vZC7pWNI3sSFFevRlkAqX"
}

resource "segment_tracking_plan" "id-tp_2yI9d8vZC7pWNI3sSFFevRlkAqX" {
