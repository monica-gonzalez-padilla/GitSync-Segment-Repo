import {
  to = segment_destination_subscription.id-650b16d5c8b925499e4b76d6_45ktCFkt1xRQhZwdo3F3v8
  id = "650b16d5c8b925499e4b76d6:45ktCFkt1xRQhZwdo3F3v8"
}

resource "segment_destination_subscription" "id-650b16d5c8b925499e4b76d6_45ktCFkt1xRQhZwdo3F3v8" {
  ...
  trigger = "type = \"track\" and contains(event, \"Audience Entered\") and properties.audience_key = \"favorite_color_red\""
}